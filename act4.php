...
$sql = "SELECT operating_profit_margin FROM User_info WHERE email = '$email'";
$result = $conn->query($sql);

// Fetch the net_profit_margin
if ($result->num_rows > 0) {
    $data = array();
    while ($row = $result->fetch_assoc()) {
        $data[] = $row['operating_profit_margin'];
    }
...
.card {
    background: linear-gradient(45deg, gold, blue);
    border-radius: 10px;
...
<body>
    <header class = "header">
        <h1>Act Analysis: Operating Profit Margin Recommendation</h1>
    </header>
    ...
    <main class = "main">
       ...
       <div class= "card">
       <h3>Based on our analysis of your gross profit margin:<br> 

        Good: 15% or higher<br>

        Evaluate your pricing strategy and identify opportunities to increase profit margins<br>
       Consider negotiating better pricing with suppliers or improving operational efficiency<br>

        Average: 10%<br>

         Review your cost of goods sold (COGS) and identify areas for optimization<br>
         Look for ways to reduce material costs, labor costs, or overhead expenses<br>

         Below Average: less than 10%<br>

         Conduct a thorough review of your product mix and pricing strategy to identify areas for improvement<br>
         Consider adjusting your pricing, product mix, or sourcing strategy to increase gross profit margin<br>
          </h3>
