...
<body>
  ...
  <ul>
    ...
    <li><a href="year2_data.php">Data</a></li>
        ...
        <?php
            if($flag == 0)
            {
             // echo 'here1'."<br>";
              ...
              echo '<h1>Year 2</h1>';
              echo '<form action="Data2.php" method="post">';
			...
			/*
			  ...
			  */
              ...
              echo '<input type="Submit" value = "Enter" class = "button" >&nbsp;&nbsp;&nbsp;<a  href ="year1_data.php" class = "prev-link">previous</a>&nbsp;&nbsp;&nbsp;<a href ="year3_data.php" class = "next-link">Next</a>';
              echo '</div>';
              echo '</form>';
            }
            else
