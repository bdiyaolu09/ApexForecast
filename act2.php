...
$sql = "SELECT net_profit_margin FROM User_info WHERE email = '$email'";
...
<html>
<head>
    <title> Net_Profit_Graph</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
</head>
<body>
    <header class = "header">
        <h1>Act Analysis: Net Profit Margin Recommendation Dashboard</h1>
    </header>
    ...
    <main class = "main">
       ...
       <div class= "card">
       <h3>Based on our analysis of your net profit margin:<br> 

       Good: 20% or higher<br>

       Evaluate your revenue streams and identify opportunities for growth<br>
       Consider expanding your product line or increasing prices<br>

       Average: 10%<br>

       Review your cost structure and identify areas for optimization<br>
       Look for ways to increase efficiency and reduce expenses<br>

       Below Average: less than 10%<br>

       Conduct a thorough review of your financial statements to identify areas for improvement<br>
       Consider adjusting your pricing or product mix to increase profitability<br>
       </h3>
