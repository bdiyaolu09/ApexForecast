...
$sql = "SELECT gross_profit_margin FROM User_info WHERE email = '$email'";
...
<html>
<head>
    <title> Gross_Profit_Graph</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
</head>
<body>
    <header class = "header">
        <h1>Act Analysis: Gross Profit Margin Recommendation Dashboard</h1>
    </header>
