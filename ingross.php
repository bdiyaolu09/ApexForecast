...
$sql = "SELECT gross_profit_margin, year FROM industry1 WHERE industry = '$user_industry' ORDER BY year ASC";
$result = $conn->query($sql);
...
<body>
    <header class = "header">
        <h1>Industry Trends: Predicted Gross Profit Margin Dashboard</h1>
    </header>
