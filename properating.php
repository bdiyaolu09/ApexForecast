...
$sql = "SELECT operating_profit_margin, year FROM user_info WHERE email = '$email' ORDER BY year ASC";
...
.card {
    background: linear-gradient(45deg, gold, #36454f);
    border-radius: 10px;
...
<body>
    <header class = "header">
        <h1>Trend Analysis: Predicted Operating Profit Margin Dashboard</h1>
    </header>
