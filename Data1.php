...
if(mysqli_num_rows($result) > 0) {
    echo 'me<br>';
  //update the existing data in the database
  $update_query = "UPDATE Data SET industry='$industry', net_sales =$net_sales, revenue=$revenue, cogs=$cogs, operating_profit=$operating_profit,total_cost=$total_cost,aiasp=$aiasp  WHERE email='$email' AND year= 1 ";
...
//redirect to data1.html
header("Location: year1_data.php");
exit;
?>
